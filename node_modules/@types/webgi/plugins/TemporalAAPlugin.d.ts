...
export declare class TemporalAAPlugin extends GenericFilterPlugin<TAAPass, 'taa', '', ViewerApp> implements IViewerPlugin {
    ...
    private _useTotalFrameCount;
    /**
     * Same as BaseRenderer.useTotalFrameCount Use total frame count, if this is set to true, then frameCount won't be reset when the viewer is set to dirty.
    ...
    private _useTotalFrameCountConfig;
