...
export type TSceneEvents = 'sceneUpdate' | 'addSceneObject' | 'update' | 'textureAdded' | 'activeCameraChange' | 'activeCameraUpdate' | 'sceneMaterialUpdate' | 'environmentChanged' | 'select' | 'objectUpdate' | 'materialUpdate' | 'materialChanged' | 'setView' | 'activateMain';
