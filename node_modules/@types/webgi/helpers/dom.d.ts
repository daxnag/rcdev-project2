...
export declare function getTypedArray(type: keyof typeof TYPED_ARRAYS, buffer: ArrayBuffer): Uint8Array | Float32Array | Int32Array | Int8Array | Uint8ClampedArray | Int16Array | Uint16Array | Uint32Array | Float64Array;
export declare function futch(url: string, opts?: any, onProgress?: typeof XMLHttpRequestEventTarget.prototype.onprogress): Promise<XMLHttpRequest>;
